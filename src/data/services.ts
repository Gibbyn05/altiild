...
const pipeTak = "/uploads/pipe-tak.jpg";
const tjenesterPeis = "/uploads/tjenester-peis.png";
const hvitOvn = "/uploads/hvit-ovn.jpg";
const hvitOvn2 = "/uploads/hvit-ovn-2.jpg";
const ovnSolrik = "/uploads/ovn-solrik.jpg";
const funkisOvn = "/uploads/funkis-ovn.jpg";
const installationImage = "/uploads/installation-work.jpg";
const takUtside = "/uploads/ovn-solrik.jpg";
const takInnside = "/uploads/4.png";
const stalpipeUtvendig = "/uploads/stalpipe-utvendig.jpg";
const stalpipeInnvendig = "/uploads/stalpipe-innvendig.jpg";
const takstigeNy = "/uploads/takstige-ny.png";
const galleryPipeFjord = "/uploads/gallery-pipe-fjord.jpg";
const galleryPipeRehab = "/uploads/gallery-pipe-rehabilitering.jpg";
const galleryStalpipeSvart = "/uploads/gallery-stalpipe-svart.jpg";
const galleryTakstigePlatetak = "/uploads/gallery-takstige-platetak.jpg";
const galleryTakstigeSno = "/uploads/gallery-takstige-sno.jpg";
const galleryStalpipeTakstige = "/uploads/gallery-stalpipe-takstige.jpg";
const galleryTakstigePipe = "/uploads/gallery-takstige-pipe.jpg";
const galleryStalpipePlatetak = "/uploads/gallery-stalpipe-platetak.jpg";
const galleryStalpipeFeieplattform = "/uploads/gallery-stalpipe-feieplattform.jpg";
const galleryExodraft1 = "/uploads/gallery-exodraft-1.jpg";
const galleryExodraft2 = "/uploads/gallery-exodraft-2.jpg";
const galleryExodraft3 = "/uploads/gallery-exodraft-3.jpg";
const galleryPipehatt1 = "/uploads/gallery-pipehatt-1.jpg";
const galleryPipehatt2 = "/uploads/gallery-pipehatt-2.jpg";
const galleryStalpipe1 = "/uploads/gallery-stalpipe-1.jpg";
const galleryStalpipe2 = "/uploads/gallery-stalpipe-2.jpg";
const galleryStalpipe3 = "/uploads/gallery-stalpipe-3.jpg";
const galleryStalpipe4 = "/uploads/gallery-stalpipe-4.jpg";
const galleryStalpipe5 = "/uploads/gallery-stalpipe-5.jpg";
const galleryStalpipe6 = "/uploads/gallery-stalpipe-6.jpg";
const galleryStalpipe7 = "/uploads/gallery-stalpipe-7.jpg";
...
export const services: ServiceData[] = [
  ...
  },
  {
    ...
    image: pipeTak,
    galleryImages: [
      { src: galleryPipeFjord, alt: "gallery-pipe-fjord" },
      { src: takUtside, alt: "ovn-solrik" },
  ...
  },
  {
    ...
    galleryImages: [
      { src: stalpipeUtvendig, alt: "stalpipe-utvendig" },
      { src: stalpipeInnvendig, alt: "stalpipe-innvendig" },
      { src: galleryStalpipe3, alt: "gallery-stalpipe-3" },
      { src: galleryStalpipe5, alt: "gallery-stalpipe-5" },
      { src: galleryStalpipe7, alt: "gallery-stalpipe-7", zoom: true },
      { src: galleryStalpipe2, alt: "gallery-stalpipe-2" },
      { src: galleryStalpipe4, alt: "gallery-stalpipe-4", zoom: true, objectPosition: "center 60%" },
      { src: galleryStalpipe6, alt: "gallery-stalpipe-6" },
    ],
  ...
  },
  {
    ...
    image: takstigeNy,
    galleryImages: [
      { src: galleryTakstigeSno, alt: "gallery-takstige-sno" },
      { src: galleryTakstigePlatetak, alt: "gallery-takstige-platetak" },
      { src: galleryTakstigePipe, alt: "gallery-takstige-pipe" },
    ],
    intro: "Vi monterer:",
    includes: [
      "Pipestige",

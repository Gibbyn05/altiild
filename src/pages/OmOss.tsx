          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="my-[125px]">
              ...
              <ul className="space-y-3 mb-8">
                {expertise.map(item => <li key={item} className="flex items-start gap-3">
            ...
            <div className="relative">
              <img src={larsKlemmImage} alt="Lars Klemm - grunnlegger av Alt i Ild" className="rounded-2xl shadow-2xl w-full" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div className="bg-background rounded-2xl p-8">
              ...
              <ul className="space-y-3">
                {specialCompetence.map(item => <li key={item} className="flex items-start gap-3">
            ...
            <div className="bg-background rounded-2xl p-8">
              ...
              <ul className="space-y-3">
                {certifications.map(item => <li key={item} className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">{item}</span>
                  </li>)}
              </ul>
      ...
      <section className="section-padding bg-background">
        <div className="container-wide">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            {valuesWithSixth.map(value => <div key={value.title} className="bg-muted rounded-2xl p-8 text-center hover-lift">
        ...
        <div className="container-wide">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="order-2 lg:order-1">
              <img src={galleryPipeFjord} alt="Utsikt over Molde og fjorden" className="rounded-2xl shadow-2xl w-full" />
            </div>
            <div className="order-1 lg:order-2">
              ...
              <ul className="space-y-3 mb-8">
                {["Gir optimalt trekk i kystklima", "Følger lokale forskrifter og praksis hos feiervesenet", "Tar hensyn til eldre murverk og tradisjonelle teglsteinsskorsteiner", "Sikrer korrekt godkjenning ved kommunal søknadsplikt"].map(item => <li key={item} className="flex items-start gap-3">
                    <CheckCircle className="h-5 w-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground">{item}</span>
                  </li>)}
              </ul>
              ...
              <div className="flex flex-wrap gap-2 mb-8">
                {["Molde", "Hustadvika", "Aukra", "Midsund", "Rauma"].map(area => <span key={area} className="px-4 py-2 bg-muted rounded-full text-sm text-foreground border border-border">
                    {area}
                  </span>)}
              </div>
